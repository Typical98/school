...
############################################################################################################################################################################################
##Binary Clock - I will attempt to use functions to determin if it is a 0 or 1 with if statements 
##Michael Rogers
############################################################################################################################################################################################
...
##WHILE STATEMENT TO KEEP THE CLOCK RUNNING##
while :
do
...
echo -e "\t\t  $clockhour:$clockmin:$clocksec"
